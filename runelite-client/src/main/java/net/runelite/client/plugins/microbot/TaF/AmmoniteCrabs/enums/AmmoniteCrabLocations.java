...
public enum AmmoniteCrabLocations {
    ...
    SOUTH_WEST("South West (3 spot)", new WorldPoint(3719, 3846, 0), new WorldPoint(3726, 3839, 0), new WorldPoint(3680, 3844, 0)),
    SOUTH_EAST("South West (3 spot)", new WorldPoint(3734, 3846, 0), new WorldPoint(3734, 3839, 0), new WorldPoint(3736, 3818, 0));
